...
import { __spreadArrays, __extends, __awaiter, __generator } from 'tslib';
...
import neo4j__default, { isInt, integer, auth, driver } from 'neo4j-driver';
...
function (_super) {
  ...
  function Skip(amount) {
    ...
    _this.amount = amount;
    _this.amountParam = _this.addParam(neo4j__default.int(amount), 'skipCount');
    return _this;
  }
...
function (_super) {
  ...
  function Limit(amount) {
    ...
    _this.amount = amount;
    _this.amountParam = _this.addParam(neo4j__default.int(amount), 'limitCount');
    return _this;
  }
...
function (_super) {
  ...
  function Connection(url, auth$1, options) {
    ...
    _this.auth = isCredentials(auth$1) ? auth.basic(auth$1.username, auth$1.password) : auth$1;
    var driverConstructor = isTrueFunction(options) ? options : options.driverConstructor ? options.driverConstructor : driver;
