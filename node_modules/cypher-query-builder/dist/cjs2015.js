...
var neo4j__default = _interopDefault(neo4j);
...
class Connection extends Builder {
  ...
  run(query) {
    return tslib.__awaiter(this, void 0, void 0, function* () {
      ...
      }), error => tslib.__awaiter(this, void 0, void 0, function* () {
        yield session.close();
        throw error;
      }));
    });
  ...
  stream(query) {
    return new rxjs.Observable(subscriber => {
      ...
      result.subscribe({
        ...
        onError: error => tslib.__awaiter(this, void 0, void 0, function* () {
          yield session.close();
        ...
        onCompleted: () => tslib.__awaiter(this, void 0, void 0, function* () {
          yield session.close();
